...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-yellow-50 to-blue-50">
      {/* Header */}
      <header className="bg-gradient-to-br from-white via-yellow-100 to-yellow-50 shadow-lg relative z-20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex justify-between items-center py-6">
            <div className="text-3xl font-serif font-extrabold bg-gradient-to-r from-yellow-500 via-yellow-400 to-yellow-600 bg-clip-text text-transparent drop-shadow-lg tracking-tight">
              corevist.
            </div>
            ...
            <nav className="hidden md:flex items-center space-x-10">
              <Link
                href="#"
                className="text-yellow-700 hover:text-yellow-600 transition-colors font-medium text-lg"
              >
                product 1
              </Link>
              <Link
              ...
              <button className="bg-gradient-to-r from-yellow-400 to-yellow-600 text-white px-6 py-2 rounded-xl font-bold hover:from-yellow-500 hover:to-yellow-700 transition-all duration-300 shadow-lg ml-4">
                Contact Us
              </button>
            </nav>
            {/* Mobile Menu Button */}
            <button className="md:hidden p-2 rounded-xl bg-gradient-to-br from-yellow-400 to-yellow-600 text-white shadow-lg">
              <svg
                className="w-6 h-6"
                fill="none"
                stroke="currentColor"
      ...
      {/* Alert Bar */}
      <div className="bg-gradient-to-r from-yellow-200 via-yellow-100 to-yellow-300 text-yellow-900 font-semibold shadow-md">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-white via-yellow-50 to-blue-50 py-12 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid md:grid-cols-5 gap-12 items-center">
            ...
            <div className="md:col-span-3">
              ...
              <div className="mb-6">
                <ul className="space-y-3">
                  <li className="flex items-start">
                    <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-gradient-to-br from-yellow-300 to-yellow-500 shadow-lg mr-3">
                      <svg
              ...
              <button className="bg-gradient-to-r from-yellow-400 to-yellow-600 text-white px-8 py-4 rounded-2xl font-bold text-lg shadow-xl hover:from-yellow-500 hover:to-yellow-700 transition-all duration-300 flex items-center">
                REQUEST QUOTE
                <svg
      ...
      <section className="bg-gradient-to-br from-white via-yellow-50 to-blue-50 text-yellow-900 py-20 relative overflow-hidden">
        {/* Light luxury background pattern overlay */}
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              <ul className="space-y-6 mb-10">
                <li className="flex items-start">
                  <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-br from-yellow-300 to-yellow-500 shadow-lg mr-4">
                    <svg
              ...
              <p className="text-yellow-800 mb-10 text-lg font-light">
                We obsess over every detail, so you can focus on your craft. More
                vibrant results, fewer issues, and customers who love your work.
              </p>
              <button className="bg-gradient-to-r from-yellow-400 to-yellow-600 text-white px-8 py-4 rounded-xl font-bold text-lg shadow-lg hover:from-yellow-500 hover:to-yellow-700 transition-all duration-300 flex items-center">
                Read Client Stories
                <svg
                  className="w-5 h-5 ml-2"
                  fill="none"
            ...
            <div className="bg-white text-yellow-900 p-10 rounded-2xl border-2 border-yellow-200 shadow-2xl relative">
      ...
      {/* Deploy Section */}
      <section className="bg-gradient-to-br from-white via-yellow-50 to-blue-50 py-20 relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-0 left-0 w-full h-full bg-[url('https://www.transparenttextures.com/patterns/diamond-upholstery.png')] opacity-5"></div>
          ...
          <div className="text-center">
            ...
            <div className="mb-14">
              ...
              <p className="text-2xl text-yellow-800 max-w-4xl mx-auto leading-relaxed mb-10 font-light">
                ...
                logistics network ensures prompt, safe, and professional delivery
                to your door.
              </p>
            </div>
            {/* Feature Grid */}
            <div className="grid md:grid-cols-3 gap-8 mb-14">
              <div className="group">
                <div className="relative bg-white border border-yellow-200 rounded-2xl p-8 text-center shadow-xl overflow-hidden transition-all duration-500 group-hover:scale-105 group-hover:-translate-y-2">
                  <div className="w-16 h-16 bg-gradient-to-br from-yellow-300 to-yellow-500 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg group-hover:rotate-6 transition-transform duration-300 border-2 border-yellow-100">
                    <svg
            ...
            <div className="relative group mb-10">
              <button className="relative bg-gradient-to-r from-yellow-400 to-yellow-600 text-white px-12 py-5 rounded-2xl font-bold text-2xl hover:from-yellow-500 hover:to-yellow-700 transition-all duration-500 transform group-hover:scale-105 group-hover:-translate-y-1 shadow-2xl flex items-center mx-auto border border-yellow-200">
                REQUEST QUOTE
                <svg
      ...
      {/* Footer */}
      <footer className="bg-gradient-to-br from-yellow-100 via-blue-100 to-yellow-200 py-20 pb-8 relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col sm:flex-row gap-6 mb-20 justify-center">
            <div className="group relative">
              <button className="relative bg-gradient-to-r from-yellow-400 to-yellow-600 text-white px-8 py-4 rounded-2xl font-semibold text-lg hover:from-yellow-500 hover:to-yellow-700 transition-all duration-500 transform group-hover:scale-105 group-hover:-translate-y-1 shadow-2xl flex items-center justify-center border border-yellow-200">
                Contact Sales
              </button>
            </div>
            <div className="group relative">
          ...
          <div className="grid lg:grid-cols-5 gap-12 mb-8">
            <div className="lg:col-span-2">
              <div className="bg-gradient-to-br from-yellow-100/50 to-yellow-50/50 backdrop-blur-sm border border-yellow-200 rounded-2xl p-8">
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li>
                  <Link
                    href="#"
                    className="text-yellow-700 hover:text-yellow-900 transition-colors duration-300 flex items-center group"
                  >
            ...
            <div className="flex flex-col lg:flex-row justify-between items-center">
              <div className="flex flex-col lg:flex-row items-center lg:space-y-0 lg:space-x-8 mb-0 lg:mb-0">
                ...
                <div className="flex space-x-6 text-sm">
                  <Link
                    href="#"
                    className="text-yellow-700 hover:text-yellow-900 transition-colors duration-300"
                  >
                    Privacy Policy
                  </Link>
                  <Link
              ...
              <div className="flex items-center space-x-8">
                <div className="text-3xl font-bold text-yellow-900">corevist.</div>
                <div className="flex space-x-4">
                  <Link
                    href="#"
                    className="w-12 h-12 bg-gradient-to-br from-yellow-400 to-yellow-500 rounded-2xl flex items-center justify-center text-white hover:from-yellow-500 hover:to-yellow-600 transition-all duration-300 transform hover:scale-110 hover:-translate-y-1 shadow-lg hover:shadow-xl"
                  >
                    <svg
                      className="w-5 h-5"
                      fill="currentColor"
